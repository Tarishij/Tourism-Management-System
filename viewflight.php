...
.bg {
    /* The image used */
    background-image: url("http://www.letaximetre.fr/blog/wp-content/uploads/2017/12/maxresdefault.jpg");
...
<div class="navbar" >
  ...
  <a class= "active" href="viewflight.php">Flight</a>
  ...
  <?php
    ...
    mysqli_select_db($conn,'db');
      $q1="select distinct(destination) from flight;" ;
    ...
    $q2="select distinct(source) from flight;" ;
  ...
  <pre>
  <form method=POST action="flight1.php">
    ...
    <input type="submit" id="btn" name="search"   value="Search" ></center>
  </form>
</pre>
