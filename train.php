...
<div class="navbar">
  <pre><h2 style="color:red;font-size=30px">      EXPLORE AT</p></pre>
    ...
    <form class="container" method="POST">
        ...
        <input type="text" id="userpwd" placeholder="Enter name" name="tname"/><br>
        <label  >Departure Time:</label>
        <input type="text" id="userpwd" placeholder="Enter departure time" name="dep"/><br>
        <label >Arrival Time:</label>
        <input type="text" id="userpwd" placeholder="Enter arrival time" name="arr"/>
        <label >AC Amount</label>
        <input type="text" id="userpwd" placeholder="Enter AC amount" name="ac"/><br>
        <label >Non AC Amount:</label>
        <input type="text" id="userpwd" placeholder="Enter non AC amount" name="nonac"/>
        <input type="submit" id="btn" formaction="traininfo.php"  name="admin" value="Done">
    </form>
</div>
</body>
</html>